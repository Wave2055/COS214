ofiles = TestingMain.o Shape.o Rectangle.o Square.o Textbox.o ShapeFactory.o RectangleFactory.o SquareFactory.o TextboxFactory.o Canvas.o Memento.o ExportCanvas.o PDFExporter.o PNGExporter.o
